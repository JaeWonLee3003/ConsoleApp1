    ...
    public class StartWhile
    {
        public static void Main(string[] argsr)
        {
            ...
            while (StartMain.whileTrue) // 바로 활성화
            {
                ...
                UserInput(StartMain, EndMain, out LP, out StartArr, out EndArr);
                // 계산하는 함수
                PrintOutput(StartMain, EndMain, LP, StartArr, EndArr);
            }
        }

        private static void PrintOutput(StartBox StartMain, EndBox EndMain, LadderPosition LP, string[] StartArr, string[] EndArr)
        {
        ...
        private static void UserInput(StartBox StartMain, EndBox EndMain, out LadderPosition LP, out string[] StartArr, out string[] EndArr)
        {
